...
print("Corayme Sandoval")
print("Rice and chicken")
print(int(5))
...
students_name = "Corayme Sandoval"
students_age = 17
account_balance = 50.50
...
quotation = number_one / number_two

print("The total is:", total)
print("The difference is:", difference)
print("The product is:", product)
print("The quotation is:", quotation)
print()
...
price = 14
quantity = 7
purchanse_total = price * quantity
...
print("Daily pay is:", daily_pay)
print()
weekly_pay = daily_pay * 5
print("Weekly pay is:", weekly_pay)
month_pay = weekly_pay * 4
print("Monthly pay is:", month_pay)
yearly_pay = month_pay * 12
print("Yearly pay is:", yearly_pay)
...
print()
print("The sum of your two numbers is:", user_sum)
print("The difference of your two numbers is:", user_difference)
print("The product of your two numbers is:", user_product)
print("The quotient of your two numbers is:", user_quotient)
...
result = fav_number * approximate_age

print("Hello, " + first_name)
print("Your appriximate age is:", approximate_age)
print("Your favorite number multiplied by your age is:", result)
